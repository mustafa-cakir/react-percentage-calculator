...
const WhatIsPercentageOf = () => {
    ...
    const inputChangeHandler = () => {
        ...
        if (number1 !== 0 && number2 !== 0) {
            calculateResult = precisionRound((number2 / 100) * number1);
        }
    ...
    return (
        <div className="white-box">
            <div className="mb-3">Calculate percentage of a number.</div>
            <div className="row align-items-center mb-3">
                ...
                <div className="col p-0 col-auto">% of</div>
...
export default WhatIsPercentageOf;
