...
const IsWhatPercentageOf = () => {
    ...
    const inputChangeHandler = () => {
        ...
        if (number2 > number1 && number1 !== 0 && number2 !== 0) {
            calculateResult = precisionRound((number1 * 100) / number2, 2);
        }
    ...
    return (
        <div className="white-box">
            <div className="mb-3">Calculate percentage of another number.</div>
            <div className="row align-items-center mb-3">
                ...
                <div className="col p-0 col-auto">is what % of</div>
            ...
            {result !== 0 && (
                <div className="result-box mb-3">
                    <div className="row align-items-center">
                        <div className="col">
                            Result: <span className="text-large ml-3 mr-1">{result.toLocaleString()}</span> %
                        </div>
...
export default IsWhatPercentageOf;
